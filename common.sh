...
echo "********** $KVMSG"
echo "********** $KVMSG"
apt-get install -y chrony avahi-daemon libnss-mdns traceroute htop httpie bash-completion docker-ce=5:19.03.14~3-0~ubuntu-focal kubeadm=1.19.5-00 kubelet=1.19.5-00 kubectl=1.19.5-00 python3 python3-pip
